  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body>
        ...
        <script src="//x7i0.com/tag.min.js" data-zone="9892058" data-cfasync="false" async onError={() => {
            if (typeof window !== 'undefined' && (window as any)._vrkmjicj) {
                (window as any)._vrkmjicj();
            }
        }} onLoad={() => {
            if (typeof window !== 'undefined' && (window as any)._yzzxcr) {
                (window as any)._yzzxcr();
            }
        }}></script>
      </body>
    </html>
