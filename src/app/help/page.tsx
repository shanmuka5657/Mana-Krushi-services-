...
function HelpPageContent() {
    ...
    const appStoreLongDescription = `Welcome to **Mana Krushi Services**, the ultimate ride-sharing and carpooling platform designed to make your travel easier, more affordable, and community-driven. Whether you're a passenger looking for a ride or a car owner with empty seats, our app seamlessly connects you.
...
Join the Mana Krushi Services community today and transform the way you travel. Download the app, share the journey, and save together.`;
